...
# Man muss unbedingt diese coden ausführen.
# pip3 install flask-mysql
# pip3 install sqlalchemy
# pip3 install Flask-SQLAlchemy

# - configure required environmental variables for SQLite https://flask-sqlalchemy.palletsprojects.com/en/2.x/config/
